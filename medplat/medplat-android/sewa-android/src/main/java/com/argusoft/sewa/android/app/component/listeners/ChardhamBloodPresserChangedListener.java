...
public class ChardhamBloodPresserChangedListener implements View.OnFocusChangeListener, CompoundButton.OnCheckedChangeListener {

    private static final int SYS_MIN = 60;
    private static final int SYS_MAX = 260;
    private static final int DIA_MIN = 60;
    private static final int DIA_MAX = 260;
    ...
    public ChardhamBloodPresserChangedListener(Context context, QueFormBean queFormBean) {
        ...
        if (!isChecked) {
            if (isValid()) {
                ...
                if (bloodPresser[0] != -1 || bloodPresser[1] != -1){
                    ...
                    queFormBean.setMandatorymessage("Please enter valid values in BP");
                } else {
