...
public class MyVideoMediaController extends FrameLayout {
...
//    private boolean mFullscreenEnabled = false;
    ...
    public MyVideoMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.MyVideoMediaController);
        mScalable = a.getBoolean(R.styleable.MyVideoMediaController_my_video_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.my_video_view_player_controller, this);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.my_video_view_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.my_video_view_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.my_video_view_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.ic_fullscreen_exit);
        } else {
            mScaleButton.setImageResource(R.drawable.ic_fullscreen_enter);
        }
    }
