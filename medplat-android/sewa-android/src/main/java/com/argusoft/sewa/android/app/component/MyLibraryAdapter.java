...
public class MyLibraryAdapter extends BaseAdapter {
    ...
    public MyLibraryAdapter(Context context, List<LibraryScreenDataBean> libraryList, String fileType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null && libraryList != null && !libraryList.isEmpty()) {
            LibraryScreenDataBean libraryScreenDataBean = libraryList.get(position);
    ...
    private View getViewAccordingToFileType() {
        ...
        switch (fileType) {
            ...
            case LibraryConstants.AUDIO:
                inflate = LayoutInflater.from(context).inflate(R.layout.library_audio_cards, null);
                inflate.setPadding(-20, 0, 0, 0);
                return inflate;
