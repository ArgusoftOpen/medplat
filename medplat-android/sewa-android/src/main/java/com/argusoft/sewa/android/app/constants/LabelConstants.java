...
public class LabelConstants {
    ...
    public static final String NO_EMERGENCY_REQUESTS_FOUND = "No emergency requests found";
    ...
    public static final String NCD_WEEKLY_CLINIC_ACTIVITY = "NCD Weekly Details";
    ...
    public static final String SUSPECTED_FOR_MENTAL_HEALTH_ISSUES = "Suspected for Mental Health Issues";
    ...
    public static final String NO_MEMBER_SUSPECTED_FOR_MENTAL_HEALTH_IN_AREA = "No members have been suspected for mental health issues in your area";
    ...
    public static final String ON_NCD_CONFIRMATION_CLOSE_ALERT = "Are you sure want to close NCD Confirmation?";
    public static final String ON_NCD_WEEKLY_VISIT_CLOSE_ALERT = "Are you sure want to close NCD Weekly Visit?";
    ...
    public static final String NO_MEMBERS_HAVING_AGE_MORE_THAN_15_YEARS_IN_FAMILY = "There is no member having age more than 15 years in this family.";
    public static final String SELECT_AN_OPTION = "Please select an option";
    public static final String WANT_TO_FILL_PERSONAL_HISTORY_FORM = "Would you like to fill Personal History Form?";
    public static final String CLINIC_VISIT = "Clinic Visit";
    public static final String HOME_VISIT = "Home Visit";
    public static final String REFERENCE_DUE = "Reference Due";
    ...
    public static final String EXAMINE_BABY_AND_SCHOOSE_FOR_DEFECTS = "Please examine the Baby carefully and make sure that there are no physical abnormalities present. " +
            "If you are sure that there are no Visual Defects then press \"No Defects\" else Choose \"Enter Visual Defects\"";
    ...
    //Formulas Util
    public static final String AADHAAR_NUMBER = "Aadhar Number";
    ...
    public static final String INFORMED_BENEFICIARY_ABOUT_ABDM_GU
            = "યુનિક આઇડેન્ટિફિકેશન ઓથોરિટી ઓફ ઇન્ડિયા (“UIDAI”) દ્વારા જારી કરાયેલ મારો આધાર નંબર/વર્ચ્યુઅલ ID અને મારી વસ્તી વિષયક માહિતી હું સ્વેચ્છાએ શેર કરું છું " +
            "આયુષ્માન ભારત હેલ્થ એકાઉન્ટ નંબર (“ABHA નંબર”) અને આયુષ્માન ભારત હેલ્થ એકાઉન્ટ એડ્રેસ (“ABHA એડ્રેસ”) બનાવવું. હું NHA નો ઉપયોગ કરવા માટે અધિકૃત કરું છું " +
            "આધારની જોગવાઈઓ અનુસાર UIDAI સાથે આધાર આધારિત પ્રમાણીકરણ કરવા માટે આધાર નંબર / વર્ચ્યુઅલ આઈડી (નાણાકીય અને અન્ય સબસિડીની લક્ષિત ડિલિવરી, " +
            "ઉપરોક્ત હેતુ માટે લાભો અને સેવાઓ) અધિનિયમ, 2016. હું સમજું છું કે UIDAI મારી ઇ-કેવાયસી વિગતો અથવા સફળ પ્રમાણીકરણ પર NHA સાથે “હા” નો પ્રતિસાદ શેર કરશે.";

    public static final String OFFLINE_ABHA_NUMBER_CREATION_MESSAGE = "Offline ABHA number creation will be initiated once the app is synced with the server.";
    public static final String CONSENT_HEADING = "I hereby declare that:";
    public static final String CONSENT_HEADING_GU = "હું આથી જાહેર કરું છું કે:";

    public static final String CONSENT_OTHER_THAN_AADHAAR = "I intend to create Ayushman Bharat Health Account Number (“ABHA number”) and Ayushman Bharat Health Account address (“ABHA Address”) using document other than " +
            "Aadhaar. (Click here to proceed further)";
    public static final String CONSENT_OTHER_THAN_AADHAAR_GU = "હું આયુષ્માન ભારત હેલ્થ એકાઉન્ટ નંબર (“ABHA નંબર”) અને આયુષ્માન ભારત હેલ્થ એકાઉન્ટ એડ્રેસ (“ABHA એડ્રેસ”) સિવાયના અન્ય દસ્તાવેજોનો ઉપયોગ કરીને બનાવવા માગું છું. " +
            "આધાર. (વધુ આગળ વધવા માટે અહીં ક્લિક કરો)";

    public static final String CONSENT_FOR_ABHA_USAGE = "I consent to usage of my ABHA address and ABHA number for linking of my legacy (past) government health records and those which will be generated during this encounter.";
    public static final String CONSENT_FOR_ABHA_USAGE_GU = "હું મારા લેગસી (ભૂતકાળના) સરકારી આરોગ્ય રેકોર્ડ અને આ એન્કાઉન્ટર દરમિયાન જે જનરેટ થશે તેને લિંક કરવા માટે મારા ABHA સરનામું અને ABHA નંબરનો ઉપયોગ કરવાની સંમતિ આપું છું.";

    public static final String CONSENT_FOR_SHARING_HEALTH_RECORDS = "I authorize the sharing of all my health records with healthcare provider(s) for the purpose of providing healthcare services to me during this encounter.";
    public static final String CONSENT_FOR_SHARING_HEALTH_RECORDS_GU = "આ એન્કાઉન્ટર દરમિયાન મને આરોગ્યસંભાળ સેવાઓ પૂરી પાડવાના હેતુથી હું મારા તમામ આરોગ્ય રેકોર્ડને આરોગ્યસંભાળ પ્રદાતા(ઓ) સાથે શેર કરવા માટે અધિકૃત કરું છું.";

    public static final String CONSENT_ANONYMIZATION = "I consent to the anonymization and subsequent use of my government health records for public health purposes.";
    public static final String CONSENT_ANONYMIZATION_GU = "હું જાહેર આરોગ્ય હેતુઓ માટે મારા સરકારી આરોગ્ય રેકોર્ડના અનામીકરણ અને અનુગામી ઉપયોગ માટે સંમતિ આપું છું.";

    public static final String I = "I";

    public static final String CONSENT_HEALTH_WORKER = "confirm that I have duly informed and explained the beneficiary of the contents of consent for aforementioned purposes.";
    public static final String CONSENT_HEALTH_WORKER_GU = "પુષ્ટિ કરું છું કે મેં ઉપરોક્ત હેતુઓ માટે સંમતિની સામગ્રીના લાભાર્થીને યોગ્ય રીતે જાણ કરી છે અને સમજાવી છે.";

    public static final String CONSENT_BENEFICIARY = "have been explained about the consent as stated above and hereby provide my consent for the aforementioned purposes.";
    public static final String CONSENT_BENEFICIARY_GU = "ઉપર જણાવ્યા મુજબ મને સંમતિ વિશે સમજાવવામાં આવ્યું છે અને આથી ઉપરોક્ત હેતુઓ માટે મારી સંમતિ પ્રદાન કરું છું.";

    public static final String READY_FOR_GIVE_CONCERN_TO_SHARE_AADHAAR_DETAILS_FOR_CREATE_HEALTH_ID
            = "I, hereby declare that I am voluntarily sharing my Aadhaar Number / Virtual ID and demographic information " +
            "issued by UIDAI, with National Health Authority (NHA) for the sole purpose of creation of ABHA number. " +
            ...
            "Further, I am aware that my personal identifiable information (Name, Address, Age, Date of Birth, Gender and Photograph) may be made available to the entities " +
            "working in the National Digital Health Ecosystem (NDHE) which inter alia includes stakeholders and entities " +
            "such as healthcare professionals (e.g. doctors), facilities (e.g. hospitals, laboratories) and data fiduciaries (e.g. health programmes), " +
            "which are registered with or linked to the Ayushman Bharat Digital Mission (ABDM), and various processes there under. " +
            "I authorize NHA to use my Aadhaar number / Virtual ID for performing Aadhaar based authentication with UIDAI as per the provisions of the Aadhaar " +
            "(Targeted Delivery of Financial and other Subsidies, Benefits and Services) Act, 2016 for the aforesaid purpose. " +
            "I understand that UIDAI will share my e-KYC details, or response of “Yes” with NHA upon successful authentication.\n\n" +
            "I have been duly informed about the option of using other IDs apart from Aadhaar; however, " +
            "I consciously choose to use Aadhaar number / Virtual ID for the purpose of availing benefits across the NDHE. " +
            ...
            "I reserve the right to revoke the given consent at any point of time as per provisions of Aadhar Act and Regulations.";
    public static final String READY_FOR_GIVE_CONCERN_TO_SHARE_AADHAAR_DETAILS_FOR_CAPTURE_HEALTH_ID
            = "Hereby declare that I am voluntarily sharing my ABHA number with TECHO_UP programme/ application. " +
            "I am aware that TECHO_UP will authenticate my ABHA number with the ABDM system. " +
            "I understand that this ABHA number may be linked with the Identification number that TECHO_UP may generate.";
    public static final String OKAY = "Okay";
    public static final String HEALTH_ID_MANAGEMENT = "Create ABHA";
    public static final String CREATE_HEALTH_ID = "Create ABHA number";
    public static final String LINK_HEALTH_ID = "Link ABHA number";
    public static final String AADHAAR_BASED_AUTHENTICATION = "Aadhaar based authentication";
    public static final String SELECT_METHOD_FOR_ABHA_CREATION = "Select method for ABHA id creation";
    public static final String AADHAAR_OTP_AUTHENTICATION = "Aadhaar OTP Authentication";
    public static final String AADHAAR_FINGERPRINT_AUTHENTICATION = "Aadhaar Fingerprint Authentication";
    public static final String AADHAAR_DEMOGRAPHIC_AUTHENTICATION = "Aadhaar Demographic Authentication (offline)";
    public static final String BIRTH_DATE = "Birth Date";
    public static final String REGISTER = "Register";
    public static final String LINK = "Link";
    public static final String ENTER_OTP = "Enter OTP";
    public static final String ENTER_PASSWORD = "Enter Password";
    public static final String SEND_OTP = "Proceed";
    public static final String VALIDATE = "Validate";
    public static final String MOBILE_NUMBER_LINKED_WITH_AADHAAR_NUMBER = "Mobile Number (Linked with Aadhaar number)";
    public static final String ARE_YOU_SURE_WANT_TO_CLOSE_HEALTH_ID_CREATION = "Are you sure want to close ABHA number creation?";
    public static final String ARE_YOU_SURE_WANT_TO_CLOSE_HEALTH_ID_LINK = "Are you sure want to close link ABHA number?";
    public static final String HEALTH_ID_NUMBER = "ABHA Number";
    public static final String SELECT_STATE = "Select State";
    public static final String PLEASE_ENTER_THE_OTP_RECEIVED_ON_THE_AADHAAR_LINKED_MOBILE_NUMBER = "Please enter the OTP received on the Aadhaar linked Mobile Number";
    public static final String PLEASE_ENTER_THE_OTP_RECEIVED_ON_THE_MOBILE_NUMBER = "Please enter the OTP received on the Mobile Number";
    public static final String PLEASE_ENTER_ALL_DETAILS_AS_GIVEN_IN_THE_AADHAAR_CARD = "Please enter all details as given in the Aadhaar Card.";
    public static final String AN_OTP_WILL_BE_SENT_TO_THE_MOBILE_PHONE_NUMBER_LINKED_TO_THIS_AADHAAR_NUMBER = "An OTP will be sent to the mobile phone number linked to this Aadhaar number.";
    public static final String AN_OTP_WILL_BE_SENT_TO_THE_MOBILE_PHONE_NUMBER_LINKED_TO_THIS_HEALTH_ID = "An OTP will be sent to the mobile phone number linked to this ABHA number.";
    public static final String ENTER_PASSWORD_TO_VERIFY_HEALTH_ID = "Enter password to verify ABHA number.";
    public static final String TAP_HERE_TO_CREATE_OR_LINK_HEALTH_ID_FOR_THE_BENEFICIARY = "Tap here to create or link ABHA number for the beneficiary";
    public static final String HEALTH_ID_GENERATED_SUCCESSFULLY = "ABHA number generated successfully";
    public static final String HEALTH_ID_LINKED_SUCCESSFULLY = "ABHA number linked successfully";
    public static final String SELECT_AUTH_MODE_TO_LINK_HEALTH_ID = "Select auth mode to link ABHA number";
    public static final String PLEASE_ENTER_HEALTH_ID = "Please enter ABHA Number";
    public static final String PLEASE_ENTER_HEALTH_ID_IN_PROPER_FORMAT = "Please enter the ABHA number in proper format (XX-XXXX-XXXX-XXXX)";
    public static final String ONLINE = "Online";
    public static final String OFFLINE = "Offline";
    public static final String HOW_TO_CREATE_ABHA_NUMBER = "How to create ABHA number?";
    public static final String ABHA_OFFLINE_CONSENT = "I have verified that the details entered match with the beneficiary AADHAR details";
    public static final String CREATE_HEALTH_ID_FOR_NEW_MEMBER = "Create ABHA Number For New Member";
    public static final String CREATE_HEALTH_ID_FOR_EXISTING_MEMBER = "Create ABHA Number For Existing Member";
    public static final String ABHA_NUMBER_IS_ALREADY_LINKED_MSG = "Abha Number is already linked with this member";
    public static final String MOBILE_NUMBER_HINT_FOR_ABHA = "You will get link to download ABHA card on this number";
    public static final String HEALTH_ID_CARD_MESSAGE = "Please inform the beneficiary that they will get link to download ABHA card";
    public static final String RD_SERVICE_DRIVERS_NOT_FOUND = "RD service drivers not found, Please make sure your fingerprint device connected properly";
    public static final String RD_SERVICE_DRIVERS_DISCOVERY_FAILED = "RD service drivers discovery failed, Please make sure your fingerprint device connected properly";
    public static final String RD_SERVICE_CAPTURE_FAILED = "Finger print capture failed, Please make sure your fingerprint device connected properly";
    public static final String ABHA_OFFLINE_PROCESS_INITIATED = "You have already initiated the offline abha creation for this, Please sync your application first.";
    ...
    public static final String SELECT_TOPICS = "Select a Topic";
    public static final String NO_TOPICS_AVAILABLE = "No topics are available in the selected course.";
    public static final String SELECT_VIDEO = "Select a video";
    public static final String NO_VIDEO_AVAILABLE = "No videos are available in the selected topic.";
    ...
    public static final String SCAN_QR_TEXT = "Tap on above icon to scan QR code and find pilgrim";

    //LMS Progress Report Related
    public static final String LMS_PROGRESS_REPORT_TITLE = "LMS Progress Report";
    public static final String NO_QUIZ_HAS_BEEN_COMPLETED_YET = "No quiz has been completed yet.";
    public static final String CLOSE_LMS_PROGRESS_REPORT_ACTIVITY = "Are you sure want to close LMS Progress Report?";
    public static final String SELECT_A_QUIZ_TO_VIEW_DETAILS = "List of Quiz taken by you. Select a Quiz to view it's details";
    public static final String PLEASE_SELECT_A_QUIZ = "Please select a quiz";
    public static final String QUIZ_FOR = "Quiz for";
    public static final String QUIZ_TYPE = "Quiz Type";
    public static final String NUMBER_OF_ATTEMPTS = "Number of attempts";
    public static final String LATEST_SCORE = "Latest score";

    public static final String PLEASE_COMPLETE_HEALTH_SCREENING = "Please complete health screening first";
    public static final String REMARKS = "Remarks";
    public static final String AGE_AT_MENARCHE = "Age at Menarche";
    public static final String REGULAR_PERIOD = "regular Periods";
    public static final String CONFORMATION_TO_CANCEL_VIEWING_PERSONAL_HISTORY_DETAILS = "Are you sure want to cancel viewing Personal History Details?";
    public static final String NCD_PERSONAL_HISTORY_DETAILS_ACTIVITY = "NCD Personal History Details";
    public static final String SPECIFY_OTHER_DIAGNOSIS = "Please specify";
    public static final String RECURRENT_ULCERATION = "Recurrent ulceration in Palm or Sole";
    public static final String RECURRENT_TINGLING = "Recurrent tingling in Palm(s) or Sole(s)";
    public static final String CLOUDY_VISION = "Cloudy or blurred vision";
    public static final String READING_DIFFICULTY = "Difficulty in reading";
    public static final String EYE_PAIN = "Pain in eye lasting for more than a week";
    public static final String EYE_REDNESS = "Redness in eyes lasting for more than a week";
    public static final String HEARING_DIFFICULTY = "Difficulty in hearing";
    public static final String CHEWING_PAIN = "Pain while chewing";
    public static final String CROP_BURNING = "Crop residue burning";
    public static final String BURNING_OF_GARBAGE = "Burning of garbage Leaves";
    public static final String WORKING_IN_INDUSTRY_WITH_SMOKE_GAS = "Working in industries with smoke gas";
    public static final String INTEREST_OR_PLEASURE = "Little interest or pleasure in doing things";
    public static final String FEELING_DEPRESSED = "Feeling down depressed and hopeless";
    public static final String THICKENED_SKIN = "Any Thickened Skin";
    public static final String NODULES_ON_SKIN = "Any nodules on skin";
    public static final String CLAWING_OF_FINGERS = "Clawing of fingers in hand(s) and/or feet";
    public static final String TINGLING_IN_HANDS = "Tingling numbness in hand and/or feet";
    public static final String INABILITY_TO_CLOSE_EYELID = "Inability to close eyelid";
    public static final String WEAK_FEET = "Weakness in feet that causes difficulty in walking";
    public static final String FEELING_UNSTEADY = "Feeling unsteady while standing or walking";
    public static final String PHYSICAL_DISABILITY = "Suffering from any physical disability that restricts movement";
    public static final String NEED_HELP_FROM_OTHERS = "Needing help from others to perform everyday activities such as eating, getting dressed, grooming, bathing, walking, or using toilets";
    public static final String FORGET_NAMES = "Forgetting names of your near ones or your own home address";
    public static final String ULCERS_IN_MOUTH_NOT_HEALDED_IN_2_WEEKS = "Any ulcers in mouth that has not healed in two weeks";
    public static final String GROWTH_IN_MOUTH_NOT_HEALDED_IN_2_WEEKS = "Any growth in mouth that has not healed in two weeks";
    public static final String PATCH_IN_MOUTH_NOT_HEALDED_IN_2_WEEKS = "Any white or red patch in mouth that has not healed in two weeks";


    public static final String CPHC = "CPHC";
    public static final String OUTSIDE = "OUTSIDE";
    public static final String CONFIRMED_DISEASE = "Confirmed Disease – Treatment Status";
    public static final String EVENING = "Available in evening";
    public static final String AVAILABLE_EVENING = "Member evening availability updated";
    public static final String PH_ENTRY_FOR_SELECTED_MEMBER_IS_ALREADY_DONE = "Personal History Entry for selected member is already done.";
    ...
    public static final String TRACK_REQUESTS = "Track Emergency Requests";
    public static final String PLEASE_ENTER_REQUEST_FOR = "Please select to whom you want to request for";
    public static final String PLEASE_ENTER_EMR_DESC = "Please describe emergency situation in short";
    public static final String SENDING_REQ_FOR_EMR = "We are sending request to %s please wait while he accepts your request";
    public static final String TRACKING_REQUESTS = "Emergency Requests";
    public static final String NAVIGATE = "Navigate to maps";
    public static final String CANCEL_REQ = "Cancel Request";
    public static final String SCREENING_HISTORY_ACTIVITY = "SCREENING_HISTORY_ACTIVITY";
    public static final String DYNAMIC_FORM_ACTIVITY = "DYNAMIC_FORM_ACTIVITY";
    public static final String CHARDHAM_TOURIST_ACTIVITY = "CHARDHAM_TOURIST_ACTIVITY";
    public static final String FILTER_BY_DATE = "Filter by screening date";
    public static final String FILTER_BY_REQUEST_DATE = "Filter by request date";
    public static final String SUCCESS_STATE = "SUCCESS";
    public static final String REQUEST_SENT_SUCCESSFULLY = "Request has been sent successfully, please wait while emergency supporter responds to your request";
    public static final String TREATMENT_DONE_SUCCESSFULLY = "Treatment done! Click OK to go back to screening page";
    public static final String STATUS_PENDING = "Pending";
    public static final String STATUS_ONGOING = "Ongoing";
    public static final String STATUS_COMPLETED = "Completed";
    public static final String STATUS_REJECTED = "Rejected";
    public static final String STATUS_NO_RESPONSE = "No Response";
    public static final String CHARDHAM = "Chardham";
    ...
    public static final String CHARDHAM_EMERGENCY_NO_RESPONSE = "CHARDHAM_EMERGENCY_NO_RESPONSE";
    ...
    public static final String SELECT_TREATMENT_CHIP = "Tap here to select from list";
    public static final String NO_HEALTH_INFRA_ASSIGNED = "No health infra assigned as default, please contact admin";
    public static final String SOME_ERROR_OCCURRED_PLEASE_TRY_AGAIN = "Some error occurred, please try again after sometime";
    public static final String INVALID_UNIQUE_ID = "Invalid Unique ID";
}
