...
//                    alert(JSON.stringify(upload));
                ...
                onUploaded: function (upload) {
                    upload.funcid=upload.url;
                    // Set width and height to prevent blinking.
                    this.replaceWith('<img class="myImg" id="'+upload.funcid+'" src="'  + upload.url + '" ' +
                            'width="' + this.parts.img.$.naturalWidth + '" ' +
                            'height="' + this.parts.img.$.naturalHeight + '">');
//                    this.parts.img.setAttribute('onload', 'window.parent.setImgSrc("' + upload.funcid + '","'+upload.url+'")');
