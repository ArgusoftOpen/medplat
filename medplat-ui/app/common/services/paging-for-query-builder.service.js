(function () {
    var PagingForQueryBuilderService = function (APP_CONFIG, $q) {
        var ctrl = this;
        ctrl.busy = false;
        ctrl.offSet = 0;
    ...
    angular.module("imtecho.service").service('PagingForQueryBuilderService', PagingForQueryBuilderService);
})();
