...
/**
 * <p>
 * Mapper for member CBAC  in order to convert dto to model or model to dto.
 * </p>
 *
 * @author prateek
...
public class MemberCbacDetailMapper {
    private MemberCbacDetailMapper() {
        throw new IllegalStateException("Utility Class");
    }

    /**
     * Convert member's CBAC details into entity.
     *
     * @param memberCbacDetail Member's CBAC details.
     * @return Returns entity of member CBAC.
     */
