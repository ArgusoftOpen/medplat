...
//                .antMatchers("/node/**").permitAll()
                ...
                .antMatchers("/api/table-metadata/**").permitAll()
                .antMatchers("/api/sample-data/**").permitAll()
                .antMatchers("/api/attribute-value").permitAll()
                .antMatchers("/api/data").permitAll()
                .antMatchers("/api/preview-sql").permitAll()
                .antMatchers("/api/derived-attribute").permitAll()
                .antMatchers("/api/derived-attributes").permitAll()
                .antMatchers("/api/indicator-master").permitAll()
                .antMatchers("/api/grouped-count").permitAll()
                .antMatchers("/api/run-sql").permitAll()
                .antMatchers("/api/test-db").permitAll()
                .antMatchers("/api/dataset-master").permitAll()
                .antMatchers("/api/dataset-master/**").permitAll()
                .antMatchers("/api/save-dataset").permitAll()
                .antMatchers("/api/dataset-chart").permitAll()
