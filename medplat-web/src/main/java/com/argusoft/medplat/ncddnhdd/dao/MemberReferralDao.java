...
public interface MemberReferralDao extends GenericDao<MemberReferral, Integer> {
    ...
    List<MemberReferralDnhddDto> retrieveMembersNew(Integer userId, Integer limit, Integer offset, String healthInfrastructureType, String searchBy, String searchString, Boolean isSus);
