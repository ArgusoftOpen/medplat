...
CREATE TABLE public.imt_member_ncd_detail (
	id serial4 NOT NULL,
	member_id int4 NOT NULL,
	location_id int4 NULL,
...
INSERT INTO public.menu_config (feature_json,group_id,active,is_dynamic_report,menu_name,navigation_state,sub_group_id,menu_type,only_admin,menu_display_order,"uuid",group_name_uuid,sub_group_uuid,description) VALUES
	 ('{"canDrillDown":true}',28,true,true,'NCD Form Fillup (Location wise)','techo.report.view({id:''000e1c87-978a-4c44-ba70-9b3e8eee66b3''})',NULL,'ncd',NULL,NULL,'cf7ccbb7-b36f-4a4a-82ed-0ec69f0ff2c6','c010e432-20b6-4199-bf51-436bb76517b9',NULL,NULL),
	 ('{"canDrillDown":true}',20,true,true,'State Of Health - Elements','techo.report.view({id:''f4530015-fd6d-45bf-9b50-c2fb1f3c2976''})',NULL,'admin',NULL,NULL,'f80e9671-7f0a-4da7-957c-15cc9131a67b','6b4f9f3a-14e5-4a2e-b9bd-8c75eb794f38',NULL,NULL),
	 ('{"canDrillDown":true}',3,true,true,'HMIS Report','techo.report.view({id:''74481c42-5a91-4ba0-990a-e77e3326a0a9''})',NULL,'manage',NULL,NULL,'c05e3f5c-9aac-4796-bd8d-371189190e8c',NULL,NULL,NULL),
	 ('{"canDrillDown":true}',7,true,true,'CBAC Form Fillup Count User Wise','techo.report.view({id:''ee98259d-4c96-4aab-b30e-0c87abeea575''})',NULL,'manage',NULL,NULL,'d8077557-e38f-48e8-a0a1-68fba9f46e94','3a3ecc19-d690-4b01-8f33-f5dbe870d116','41ebb15a-cdcd-47e2-ab98-4a531919a526',NULL),
	 ('{"canDrillDown":true}',28,true,true,'NCD Screening Status','techo.report.view({id:''598bde2d-dd11-40bd-aea8-a946a9925e53''})',NULL,'ncd',NULL,NULL,'f33270ab-cba3-4bb2-82de-0f81705078ea','c3cee2f7-8de1-4ef9-9235-e79908d052c3',NULL,NULL),
	 ('{"canDrillDown":true}',28,true,true,'NCD Progress tracking report','techo.report.view({id:''04737cee-18b2-4d04-bb14-0d9ee73c67d1''})',NULL,'ncd',NULL,NULL,'70755cf6-8548-40ed-a0cc-dc7645075383','2a4bb2dd-ba0f-4145-b478-e2f4c04028e7',NULL,NULL),
...
INSERT INTO public.mobile_feature_master (mobile_constant,feature_name,mobile_display_name,state,created_on,created_by,modified_on,modified_by) VALUES
	 ('FHW_NCD_SCREENING','FHW NCD Screening','NCD Screening','ACTIVE','2021-02-09 13:33:56.038843',-1,'2021-02-09 13:33:56.038843',-1),
